        ...
        <main className="info">
                ...
                <div>
                    ...
                    <div  className="information">
                        ...
                        <img src="http://baravdg.com/wp-content/uploads/2021/05/postura.png" alt="posture" className="img-info" />
                        <h2>POSTURE</h2>
                        ...
                        <div className="info-ind">
                        <img src="http://baravdg.com/wp-content/uploads/2021/05/mover.png" alt="movility" className="img-info" />
                        <h2>MOBILITY</h2>
                        ...
                        <div className="info-ind">
                        <img src="http://baravdg.com/wp-content/uploads/2021/05/d972dfd5993c1212d51d9fa428dab9bd.png" alt="strength" className="img-info" />    
                        <h2>STRENGTH</h2>
                        ...
                        <div className="info-ind">
                        <img src="http://baravdg.com/wp-content/uploads/2021/05/1546060.png" alt="cardio" className="img-info" />
                        <h2>CARDIO</h2>
